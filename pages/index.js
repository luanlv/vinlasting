        ...
        return (
            <div>
                ...
                <div className="box_header">
                    ...
                    <div className="box_menuMain" id="box_menuMain">
                        ...
                        <div className="row">
                            ...
                            <a href="/"><img className="logo" alt src="/static/logo.jpg" /></a>
                            </div>
                            ...
                            <nav className="navbar navbar-default" role="navigation" id="navigation">
                                ...
                                <div className="navbar-header hidden-lg hidden-md">
                                    ...
                                    <a className="navbar-brand" href="/"><img style={{left: 60}} src="/static/logo.jpg" /></a>
                                ...
                                <div className="collapse navbar-collapse" id="my-navbar">
                                    ...
                                    <ul id="menu-main-menu" className><li id="menu-item-52" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-52"><a href="index.html">Trang chủ</a></li>
                                    ...
                                    <li id="menu-item-741" className="Gioithieu menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-741"><a href="#">Lĩnh vực hoạt động</a>
                                        <ul className="sub-menu">
                                        <li id="menu-item-742" className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-742"><a href="#l">In ấn</a></li>
                                        </ul>
                                    </li>
                ...
                <div className="bxslider">
                    <div className="slide"><a href="#" target="_blank">
                        <img src="http://www.hoaphat.com.vn/wp-content/uploads/lo-go-thep-xay-dung.png" />In ấn</a></div>
                    <div className="slide"><a href="#" target="_blank"><img src="http://www.hoaphat.com.vn/wp-content/uploads/lo-go-ong-thep.png" />Design</a></div>
                    <div className="slide"><a href="#" target="_blank"><img src="http://www.hoaphat.com.vn/wp-content/uploads/lo-go-dien-lanh.png" />Website</a></div>
                    <div className="slide"><a href="#" target="_blank"><img src="http://www.hoaphat.com.vn/wp-content/uploads/lo-go-thiet-bi-phu-tung.png" />Marketing</a></div>
                </div>
                </div>
                </div>
